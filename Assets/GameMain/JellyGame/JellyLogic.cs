...
namespace StarForce
{
    ...
    public class JellyLogic : EntityLogic
    {
        ...
        private readonly float _critMultiplier = GameConstants.CRIT_MULTIPLIER;
        ...
        {
            // 注意：MapManager.ApplyDamageToEntity 已经处理了数据更新和事件触发
            // 这里主要用于本地逻辑调用，或者如果需要绕过 MapManager 直接扣血（不推荐）
